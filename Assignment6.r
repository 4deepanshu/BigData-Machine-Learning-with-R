...
stack <- readLines("D:/Time-Series Analysis in R - 17th Feb/Time-Series Analysis in R - 17th Feb/forstudents - 17th & 18th Feb Sessions/forstudents-day9and10/tweets.csv")
stack
...
require(wordcloud)
set.seed(1234)
wordcloud(words= d$word, freq =d$freq, min.freq = 100000,max.words = Inf,colors=brewer.pal(n=8,name="Dark2"))
